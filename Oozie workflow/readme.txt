...
* loop_workflow.xml represents the Oozie workflow of the composition presented in Figure 10(b)
* parallel_workflow.xml represents the Oozie workflow of the composition presented in Figure 10(c)
